...
const TEAM_MEMBERS = [
  ...
  { name: 'Jack Licata', title: 'Developer', teamSection: 'Acquisitions', bio: 'PT Biz software developer and systems builder.', imageUrl: 'https://22001532.fs1.hubspotusercontent-na1.net/hubfs/22001532/JL/jack.png' },
