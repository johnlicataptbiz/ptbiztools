...
const TEAM_MEMBERS = [
  // Partners
  { name: 'Danny Matta', title: 'CEO', teamSection: 'Partners', bio: 'Former U.S. Army Physical Therapist, PT Biz co-founder, and cash-practice operator. He and Ashley scaled Athletes\' Potential to the largest cash-based practice in Georgia before selling in 2023.', imageUrl: 'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2149643710/settings_images/d55614-bc52-48d5-88d3-e5e22a4b82d5_2.png' },
  ...
  { name: 'Jerred Moon', title: 'CFO', teamSection: 'Partners', bio: 'PT Biz CFO and acquisitions leader. U.S. Air Force veteran, coach, and digital business operator with 8-figure online revenue since 2014.', imageUrl: 'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2149643710/settings_images/b05f85-5302-f230-a0cc-366c610bfb5d_1.png' },
  // Coaches
  ...
  { name: 'Jack Licata', title: 'Client Success', teamSection: 'Acquisitions', bio: 'Client Success and Acquisitions support. Assists advisor sales support plus web, AI, and workflow fulfillment; PT Biz Coach Tools creator.', imageUrl: 'https://22001532.fs1.hubspotusercontent-na1.net/hubfs/22001532/JL/jack.png' },
